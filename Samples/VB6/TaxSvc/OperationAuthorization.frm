...
Begin VB.Form formOperationAuthorization 
   ...
   End
   Begin VB.Label lblAddress 
      Caption         =   "Enter the method name(s):       e.g. GetTax, PostTax, CommitTax"
      Height          =   540
      Index           =   4
      Left            =   480
      TabIndex        =   3
...
Private Sub buttonAuthorized_Click()
    ...
    Else
        ...
        Set oIsAuthorizedResult = oTaxSvc.IsAuthorized(operations)
        ...
        Else
            ...
            End If
            'MsgBox "Result Code: " & oIsAuthorizedResult.ResultCode & vbCrLf & "# Messages: " & oIsAuthorizedResult.Messages.Count & vbCrLf & "Expires: " & oIsAuthorizedResult.Expires & vbCrLf & "Operations: " & oIsAuthorizedResult.operations, vbInformation, "IsAuthorized Result"
        End If
...
Private Sub Form_Load()
    'If (formMain.UserName <> Null Or formMain.Password <> Null) Then
