...
Begin VB.Form formSecurity 
   ...
   End
End
Attribute VB_Name = "formSecurity"
...
'    End If
    ...
    Else
        ...
        Else
            ...
            MsgBox "Result Code: " & TranslateSeverity(oIsAuthorizedResult.ResultCode) & vbCrLf & _
                "# Messages: " & oIsAuthorizedResult.Messages.Count & vbCrLf & _
                "Expires: " & oIsAuthorizedResult.Expires & vbCrLf & "Operations: " & oIsAuthorizedResult.operations, vbInformation, "Settings Result"
